 ...
 *         &lt;element name="MatchedOperation" type="{http://www.kth.se/ict/id2208/Matching}MatchedOperationType" maxOccurs="unbounded"/>
...
public class MatchedWebServiceType {
    ...
    @XmlElement(name = "MatchedOperation", required = true)
    protected List<MatchedOperationType> MatchedOperation;
    @XmlElement(name = "WsScore")
    protected String wsScore;
    ...
    /**
     * Gets the value of the MatchedOperation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the MatchedOperation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMatchedOperation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MatchedOperationType> getMatchedOperation() {
        if (MatchedOperation == null) {
            MatchedOperation = new ArrayList<MatchedOperationType>();
        }
        return this.MatchedOperation;
    }

    public void setMatchedOperation(List<MatchedOperationType> operationList) {
        this.MatchedOperation = operationList;
    }
    ...
    public void setWsScore(double value) {
        ...
        this.wsScore = numberFormat.format(value);
    }
